...
editor: visual
---
## Introduction (WP6-T6.5: An interactive GIS plattform for map dissemination)
## Aim of T6.5

An interactive GIS map portal features digital maps showcasing the study report maps developed by the SPARE project. This portal serves as a map basis for 'ecosystem accounting for the city'.
